<template>
    <div id="wrapper" :class="{'toggled':toggle}">
        ...
        <div id="page-content-wrapper">
            ...
            <sidebar v-on:toggleSideBar="toggleSideBar"
                     :menu-items="[
                   {
                      name: 'home',
                      url: 'home',
...
<script>
    import DataJson from "../static/service-data"
    //sidebar menu
    ...
    import Excode from "../components/sections/excode";
